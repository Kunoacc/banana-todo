...
<template>
  <div class="px-4 py-2.5 bg-gray-900/50 rounded">
    <div class="flex items-center gap-x-3">
      <input type="checkbox"  v-model="localTodo.completed" 
        @change="localUpdateTodo" class="h-4 w-4 border-gray-300 text-primary rounded bg-transparent focus:ring-0" />
      ...
      <p v-else class="bg-transparent text-sm font-medium leading-6 text-gray-200 line-through px-3 py-2">{{ localTodo.todo }}</p>
    </div>
  </div>
</template>